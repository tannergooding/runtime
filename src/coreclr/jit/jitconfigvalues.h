...
CONFIG_INTEGER(EnableAVX512VL,              W("EnableAVX512VL"),              1) // Allows AVX512VL+ hardware intrinsics to be disabled
CONFIG_INTEGER(EnableAVX512_BF16,           W("EnableAVX512_BF16"),           1) // Allows AVX512_BF16+ hardware intrinsics to be disabled
CONFIG_INTEGER(EnableAVX512_BITALG,         W("EnableAVX512_BITALG"),         1) // Allows AVX512_BITALG+ hardware intrinsics to be disabled
CONFIG_INTEGER(EnableAVX512_IFMA,           W("EnableAVX512_IFMA"),           1) // Allows AVX512_IFMA+ hardware intrinsics to be disabled
CONFIG_INTEGER(EnableAVX512_VBMI,           W("EnableAVX512_VBMI"),           1) // Allows AVX512_VBMI+ hardware intrinsics to be disabled
CONFIG_INTEGER(EnableAVX512_VBMI2,          W("EnableAVX512_VBMI2"),          1) // Allows AVX512_VBMI2+ hardware intrinsics to be disabled
CONFIG_INTEGER(EnableAVX512_VNNI,           W("EnableAVX512_VNNI"),           1) // Allows AVX512_VNNI+ hardware intrinsics to be disabled
CONFIG_INTEGER(EnableAVX512_VPOPCNTDQ,      W("EnableAVX512_VPOPCNTDQ"),      1) // Allows AVX512_VPOPCNTDQ+ hardware intrinsics to be disabled
CONFIG_INTEGER(EnableAVX512_VP2INTERSECT,   W("EnableAVX512_VP2INTERSECT"),   1) // Allows AVX512_VP2INTERSECT+ hardware intrinsics to be disabled
...
CONFIG_INTEGER(EnableMOVBE,                 W("EnableMOVBE"),                 1) // Allows MOVBE+ hardware intrinsics to be disabled
...
CONFIG_INTEGER(EnableX86Serialize,          W("EnableX86Serialize"),          1) // Allows X86Serialize+ hardware intrinsics to be disabled
