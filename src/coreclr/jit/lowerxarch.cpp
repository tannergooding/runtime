            ...
            else
            {
                ...
                else
                {
                    ...
                    if (dstType == TYP_UINT)
                    {
                        ...
                        convertResult = comp->gtNewSimdHWIntrinsicNode(TYP_SIMD16, result, negated, resultClone, NI_X86Base_BlendVariable, CORINFO_TYPE_FLOAT, 16);
...
GenTree* Lowering::LowerHWIntrinsic(GenTreeHWIntrinsic* node)
{
    ...
    switch (intrinsicId)
    {
        ...
        case NI_X86Base_Insert:
        {
            ...
            if ((op1Intrinsic->GetHWIntrinsicId() != NI_X86Base_Insert) || (op1Intrinsic->GetSimdBaseType() != TYP_FLOAT))
            {
