...
public:
    ...
    enum JitFlag
    {
        ...
        JIT_FLAG_DYNAMIC_ISA_CHECKS      = 32, // The EE supplies checked bodies for optional hardware intrinsics
...
#define FLAGS_EQUAL(a, b) static_assert((unsigned)(a) == (unsigned)(b))
        ...
        FLAGS_EQUAL(CORJIT_FLAGS::CORJIT_FLAG_DYNAMIC_ISA_CHECKS, JIT_FLAG_DYNAMIC_ISA_CHECKS);
