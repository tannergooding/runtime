...
INST3(movdqu,           "movdqu",           IUM_WR, SSEFLT(0x7F), BAD_CODE,     SSEFLT(0x6F),                            INS_TT_FULL_MEM,    Input_32Bit)  // TODO-XARCH-AVX512 TT and IP encoded is movdqu32
INST3(movdqa,           "movdqa",           IUM_WR, PCKDBL(0x7F), BAD_CODE,     PCKDBL(0x6F),                            INS_TT_FULL_MEM,    Input_32Bit)  // TODO-XARCH-AVX512 TT and IP encoded is movdqa32
...
INST3(vextractf128,     "extractf128",      IUM_WR, SSE3A(0x19),  BAD_CODE,     BAD_CODE,                                INS_TT_TUPLE4,  Input_32Bit )    // Extract 128-bit packed floating point values // TODO-XARCH-AVX512 TT and IP encoded is extractf32x4
INST3(vextracti128,     "extracti128",      IUM_WR, SSE3A(0x39),  BAD_CODE,     BAD_CODE,                                INS_TT_TUPLE4,  Input_32Bit )    // Extract 128-bit packed integer values // TODO-XARCH-AVX512 TT and IP encoded is extractf32x4
INST3(vinsertf128,      "insertf128",       IUM_WR, BAD_CODE,     BAD_CODE,     SSE3A(0x18),                             INS_TT_TUPLE4,  Input_32Bit | INS_Flags_IsDstDstSrcAVXInstruction)    // Insert 128-bit packed floating point values // TODO-XARCH-AVX512 TT and IP encoded is insertf32x4
INST3(vinserti128,      "inserti128",       IUM_WR, BAD_CODE,     BAD_CODE,     SSE3A(0x38),                             INS_TT_TUPLE4,  Input_32Bit | INS_Flags_IsDstDstSrcAVXInstruction)    // Insert 128-bit packed integer values // TODO-XARCH-AVX512 TT and IP encoded is inserti32x4
...
INST3(pandd,             "pandd",             IUM_WR, BAD_CODE,     BAD_CODE,     PCKDBL(0xDB),                            INS_TT_FULL,        Input_32Bit | INS_Flags_IsDstDstSrcAVXInstruction|REX_W0)    // Packed bit-wise AND of two xmm regs
INST3(pandq,             "pandq",             IUM_WR, BAD_CODE,     BAD_CODE,     PCKDBL(0xDB),                            INS_TT_FULL,        Input_64Bit | INS_Flags_IsDstDstSrcAVXInstruction|REX_W1)    // Packed bit-wise AND of two xmm regs
INST3(pandnd,            "pandnd",            IUM_WR, BAD_CODE,     BAD_CODE,     PCKDBL(0xDF),                            INS_TT_FULL,        Input_32Bit | INS_Flags_IsDstDstSrcAVXInstruction|REX_W0)    // Packed bit-wise AND NOT of two xmm regs
INST3(pandnq,            "pandnq",            IUM_WR, BAD_CODE,     BAD_CODE,     PCKDBL(0xDF),                            INS_TT_FULL,        Input_64Bit | INS_Flags_IsDstDstSrcAVXInstruction|REX_W1)    // Packed bit-wise AND NOT of two xmm regs
...
INST3(pord,              "pord",              IUM_WR, BAD_CODE,     BAD_CODE,     PCKDBL(0xEB),                            INS_TT_FULL,        Input_32Bit | INS_Flags_IsDstDstSrcAVXInstruction|REX_W0)    // Packed bit-wise OR of two xmm regs
INST3(porq,              "porq",              IUM_WR, BAD_CODE,     BAD_CODE,     PCKDBL(0xEB),                            INS_TT_FULL,        Input_64Bit | INS_Flags_IsDstDstSrcAVXInstruction|REX_W1)    // Packed bit-wise OR of two xmm regs
INST3(pxord,             "pxord",             IUM_WR, BAD_CODE,     BAD_CODE,     PCKDBL(0xEF),                            INS_TT_FULL,        Input_32Bit | INS_Flags_IsDstDstSrcAVXInstruction|REX_W0)    // Packed bit-wise XOR of two xmm regs
INST3(pxorq,             "pxorq",             IUM_WR, BAD_CODE,     BAD_CODE,     PCKDBL(0xEF),                            INS_TT_FULL,        Input_64Bit | INS_Flags_IsDstDstSrcAVXInstruction|REX_W1)    // Packed bit-wise XOR of two xmm regs
