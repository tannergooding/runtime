...
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_EnableAVX512VL,              W("EnableAVX512VL"),              1, "Allows AVX512VL+ hardware intrinsics to be disabled")
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_EnableAVX512_BF16,           W("EnableAVX512_BF16"),           1, "Allows AVX512_BF16+ hardware intrinsics to be disabled")
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_EnableAVX512_BITALG,         W("EnableAVX512_BITALG"),         1, "Allows AVX512_BITALG+ hardware intrinsics to be disabled")
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_EnableAVX512_IFMA,           W("EnableAVX512_IFMA"),           1, "Allows AVX512_IFMA+ hardware intrinsics to be disabled")
...
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_EnableAVX512_VBMI2,          W("EnableAVX512_VBMI2"),          1, "Allows AVX512_VBMI2+ hardware intrinsics to be disabled")
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_EnableAVX512_VNNI,           W("EnableAVX512_VNNI"),           1, "Allows AVX512_VNNI+ hardware intrinsics to be disabled")
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_EnableAVX512_VPOPCNTDQ,      W("EnableAVX512_VPOPCNTDQ"),      1, "Allows AVX512_VPOPCNTDQ+ hardware intrinsics to be disabled")
RETAIL_CONFIG_DWORD_INFO(EXTERNAL_EnableAVX512_VP2INTERSECT,   W("EnableAVX512_VP2INTERSECT"),   1, "Allows AVX512_VP2INTERSECT+ hardware intrinsics to be disabled")
