...
enum ReadyToRunInstructionSet
{
    ...
    READYTORUN_INSTRUCTION_Avx512Dq=30,
    READYTORUN_INSTRUCTION_Avx512Ifma=31,
    READYTORUN_INSTRUCTION_Avx512Cd=32,
    READYTORUN_INSTRUCTION_Avx512Bw=33,
    READYTORUN_INSTRUCTION_Avx512Vl=34,
    READYTORUN_INSTRUCTION_Avx512Vbmi=35,
    READYTORUN_INSTRUCTION_Avx512Vbmi2=36,
    READYTORUN_INSTRUCTION_Avx512Vnni=37,
    READYTORUN_INSTRUCTION_Avx512Bitalg=38,
    READYTORUN_INSTRUCTION_Avx512Vpopcntdq=39,
    READYTORUN_INSTRUCTION_Avx512Vp2Intersect=40,
    READYTORUN_INSTRUCTION_Avx512Bf16=41,
