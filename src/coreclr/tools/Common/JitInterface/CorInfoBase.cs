...
namespace Internal.JitInterface
{
    unsafe partial class CorInfoImpl
    {
        ...
        [UnmanagedCallersOnly]
        static CorInfoHomogenousElemType _getHomogenousTypeAndCount(IntPtr thisHandle, IntPtr* ppException, CORINFO_CLASS_STRUCT_* hClass, uint* count)
        {
            var _this = GetThis(thisHandle);
            try
            {
                return _this.getHomogenousTypeAndCount(hClass, ref *count);
            }
            catch (Exception ex)
            {
                *ppException = _this.AllocException(ex);
        ...
        static IntPtr GetUnmanagedCallbacks()
        {
            ...
            callbacks[102] = (delegate* unmanaged<IntPtr, IntPtr*, CORINFO_CLASS_STRUCT_*, uint*, CorInfoHomogenousElemType>)&_getHomogenousTypeAndCount;
