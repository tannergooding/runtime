...
CorInfoHomogenousElemType interceptor_ICJI::getHomogenousTypeAndCount(
          CORINFO_CLASS_HANDLE hClass,
          uint32_t* count)
{
    mcs->AddCall("getHomogenousTypeAndCount");
    return original_ICorJitInfo->getHomogenousTypeAndCount(hClass, count);
}
