...
LWM(GetThreadLocalStaticInfo_NativeAOT, DWORDLONG, Agnostic_GetThreadStaticInfo_NativeAOT)
...
LWM(GetCookieForInterpreterCalliSig, GetCookieForInterpreterCalliSigValue, DLDL)
...
LWM(IsGenericType, DWORDLONG, DWORD)
