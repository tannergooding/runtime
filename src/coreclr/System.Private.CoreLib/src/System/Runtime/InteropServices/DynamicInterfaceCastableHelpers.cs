    ...
    internal static class DynamicInterfaceCastableHelpers
    {
        ...
        internal static bool IsInterfaceImplemented(IDynamicInterfaceCastable castable, RuntimeType interfaceType, bool throwIfNotImplemented)
        {
            ...
            if (!isImplemented && throwIfNotImplemented)
                throw new InvalidCastException(SR.Format(SR.GetResourceString("InvalidCast_FromTo"), castable.GetType(), interfaceType));
        ...
        internal static RuntimeType? GetInterfaceImplementation(IDynamicInterfaceCastable castable, RuntimeType interfaceType)
        {
            ...
            if (!implType.IsInterface)
                throw new InvalidOperationException(SR.Format(SR.GetResourceString("IDynamicInterfaceCastable_NotInterface"), implType.ToString()));

            if (!implType.IsDefined(typeof(DynamicInterfaceCastableImplementationAttribute), inherit: false))
                throw new InvalidOperationException(SR.Format(SR.GetResourceString("IDynamicInterfaceCastable_MissingImplementationAttribute"), implType, nameof(DynamicInterfaceCastableImplementationAttribute)));

            if (!implType.ImplementInterface(interfaceType))
                throw new InvalidOperationException(SR.Format(SR.GetResourceString("IDynamicInterfaceCastable_DoesNotImplementRequested"), implType, interfaceType));
