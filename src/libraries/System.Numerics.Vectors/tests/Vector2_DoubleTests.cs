...
namespace System.Numerics.Tests
{
    public partial class Vector2DoubleTests
    {
		...
		public void Vector2DoubleDistanceTest()
		{
		    ...
		    Assert.True(MathHelper.Equal(expected, actual), "Vector2<double>.Distance did not return the expected value.");
		}
		...
		public void Vector2DoubleDistanceSquaredTest()
		{
		    ...
		    Assert.True(MathHelper.Equal(expected, actual), "Vector2<double>.DistanceSquared did not return the expected value.");
		}
		...
		public void Vector2DoubleDotTest()
		{
		    ...
		    Assert.True(MathHelper.Equal(expected, actual), "Vector2<double>.Dot did not return the expected value.");
		}
		...
		public void Vector2DoubleLengthTest()
		{
		    ...
		    Assert.True(MathHelper.Equal(expected, actual), "Vector2<double>.Length did not return the expected value.");
		}
		...
		public void Vector2DoubleLengthSquaredTest()
		{
		    ...
		    Assert.True(MathHelper.Equal(expected, actual), "Vector2<double>.LengthSquared did not return the expected value.");
		}
