...
namespace System.Numerics.Tests
{
    public partial class Vector2SingleTests
    {
		...
		public void Vector2SingleDistanceTest()
		{
		    ...
		    Assert.True(MathHelper.Equal(expected, actual), "Vector2<float>.Distance did not return the expected value.");
		}
		...
		public void Vector2SingleDistanceSquaredTest()
		{
		    ...
		    Assert.True(MathHelper.Equal(expected, actual), "Vector2<float>.DistanceSquared did not return the expected value.");
		}
		...
		public void Vector2SingleDotTest()
		{
		    ...
		    Assert.True(MathHelper.Equal(expected, actual), "Vector2<float>.Dot did not return the expected value.");
		}
		...
		public void Vector2SingleLengthTest()
		{
		    ...
		    Assert.True(MathHelper.Equal(expected, actual), "Vector2<float>.Length did not return the expected value.");
		}
		...
		public void Vector2SingleLengthSquaredTest()
		{
		    ...
		    Assert.True(MathHelper.Equal(expected, actual), "Vector2<float>.LengthSquared did not return the expected value.");
		}
