using Vector4Single = System.Numerics.Vector4<System.Single>;
/*********************************************************************************
...
{
    Vector4Single v3 = new Vector4Single(4f, 5f, 6f, 7f);
    v3 = v3.WithX(1.0f);
    v3 = v3.WithY(2.0f);
    v3 = v3.WithZ(3.0f);
    v3 = v3.WithW(4.0f);
...
public void DeeplyEmbeddedObjectTest()
{
    ...
    obj.L0.L1.L2.L3.L4.L5.L6.L7.EmbeddedVector = new Vector4Single(1, 2, 3, 4);
...
private class DeeplyEmbeddedClass
{
    ...
    public Vector4Single RootEmbeddedObject { get { return L0.L1.L2.L3.L4.L5.L6.L7.EmbeddedVector; } }
    public class Level0
    {
                    ...
                    public class Level4
                    {
                        ...
                        public class Level5
                        {
                            ...
                            public class Level6
                            {
                                ...
                                public class Level7
                                {
                                    public Vector4Single EmbeddedVector = new Vector4Single(1, 5, 1, -5);
                                }
                            }
                        }
                    }
...
private struct DeeplyEmbeddedStruct
{
    public static DeeplyEmbeddedStruct Create()
    {
        ...
        obj.L0.L1.L2.L3.L4.L5.L6.L7.EmbeddedVector = new Vector4Single(1, 5, 1, -5);
                    ...
                    public struct Level4
                    {
                        ...
                        public struct Level5
                        {
                            ...
                            public struct Level6
                            {
                                ...
                                {
                                    public Vector4Single EmbeddedVector;
                                }
                            }
                        }
                    }
