...
namespace System.Numerics.Tests
{
    public partial class Vector2DoubleTests
    {
        ...
        public void Vector2DoubleDistanceTest()
        {
            ...
            Assert.True(MathHelper.EqualScalar(expected, actual), "Vector2Double.Distance did not return the expected value.");
        }
        ...
        public void Vector2DoubleDistanceSquaredTest()
        {
            ...
            Assert.True(MathHelper.EqualScalar(expected, actual), "Vector2Double.DistanceSquared did not return the expected value.");
        }
        ...
        public void Vector2DoubleDotTest()
        {
            ...
            Assert.True(MathHelper.EqualScalar(expected, actual), "Vector2Double.Dot did not return the expected value.");
        }
        ...
        public void Vector2DoubleLengthTest()
        {
            ...
            Assert.True(MathHelper.EqualScalar(expected, actual), "Vector2Double.Length did not return the expected value.");
        }
        ...
        public void Vector2DoubleLengthSquaredTest()
        {
            ...
            Assert.True(MathHelper.EqualScalar(expected, actual), "Vector2Double.LengthSquared did not return the expected value.");
        }
