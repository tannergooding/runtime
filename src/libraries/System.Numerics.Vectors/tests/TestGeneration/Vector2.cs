...
public void Vector2DotTest2()
{
    ...
    float actual = Vector2.Dot(a, b);
    Assert.True(float.IsNegativeInfinity(actual), "Vector2.Dot did not return the expected value.");
}
...
public void Vector2LerpTest5()
{
    ...
    float t = 0.408f;
    Vector2 actual = Vector2.Lerp(a, b, t);
    Assert.True(float.IsPositiveInfinity(actual.X), "Vector2.Lerp did not return the expected value.");
    Assert.True(float.IsNegativeInfinity(actual.Y), "Vector2.Lerp did not return the expected value.");
}
...
public void Vector2NormalizeTest1()
{
    ...
    Assert.True(float.IsNaN(actual.X) && float.IsNaN(actual.Y), "Vector2.Normalize did not return the expected value.");
}
...
public void Vector2UnaryNegationTest1()
{
    ...
    Assert.True(float.IsNegativeInfinity(actual.X), "Vector2.operator - did not return the expected value.");
    Assert.True(float.IsPositiveInfinity(actual.Y), "Vector2.operator - did not return the expected value.");
}
...
public void Vector2UnaryNegationTest2()
{
    ...
    Assert.True(float.IsNaN(actual.X), "Vector2.operator - did not return the expected value.");
    Assert.True(float.Equals(0.0f, actual.Y), "Vector2.operator - did not return the expected value.");
}
...
public void Vector2DivisionTest3()
{
    ...
    Assert.True(float.IsInfinity(actual.X), "Vector2.operator / did not return the expected value.");
    Assert.True(float.IsInfinity(actual.Y), "Vector2.operator / did not return the expected value.");
}
...
// A test for Multiply (float, Vector2)
[Fact]
