...
namespace System.Numerics
{
          ...
          ISignedNumber<BigInteger>
    {
        ...
        static BigInteger INumberBase<BigInteger>.MultiplyAddEstimate(BigInteger x, BigInteger y, BigInteger addend)
        {
            // TODO: We can accelerate this and avoid an intermediate copy
            return (x * y) + addend;
        }
