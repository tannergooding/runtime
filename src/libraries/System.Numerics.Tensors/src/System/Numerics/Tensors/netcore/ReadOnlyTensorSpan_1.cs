...
namespace System.Numerics.Tensors
{
    ...
    public readonly ref struct ReadOnlyTensorSpan<T>
    {
        ...
        public static ReadOnlyTensorSpan<T> CastUp<TDerived>(ReadOnlyTensorSpan<TDerived> items)
        ...
        public ref struct Enumerator
        {
            ...
            public bool MoveNext()
            {
                ...
                TensorShape.AdjustToNextIndex(_indexes, _span.Lengths);
                _linearOffset = _span._shape.GetLinearOffset<TensorShape.GetOffsetAndLengthForNInt, nint>(_indexes);
