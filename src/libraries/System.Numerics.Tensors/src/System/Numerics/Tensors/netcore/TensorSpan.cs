...
namespace System.Numerics.Tensors
{
    ...
    public readonly ref struct TensorSpan<T>
    {
        ...
        /// <inheritdoc cref="ReadOnlyTensorSpan{T}.operator ==(ReadOnlyTensorSpan{T}, ReadOnlyTensorSpan{T})" />
        ...
        public static implicit operator ReadOnlyTensorSpan<T>(TensorSpan<T> tensor) =>
            new ReadOnlyTensorSpan<T>(ref tensor._reference, tensor._shape);

        /// <inheritdoc cref="ITensor.Clear()" />
        public void Clear() => _shape.InvokeSelf<T, TensorShape.ClearOperation<T>>(ref _reference);
        ...
        public void Fill(T value) => _shape.Invoke<T, TensorShape.FillOperation<T>>(ref _reference, value);
        ...
        public TensorSpan<T> Slice(params scoped ReadOnlySpan<nint> start)
        {
        ...
        public TensorSpan<T> Slice(params scoped ReadOnlySpan<NIndex> startIndex)
        {
        ...
        public TensorSpan<T> Slice(params scoped ReadOnlySpan<NRange> range)
        {
        ...
        public bool TryCopyTo(scoped TensorSpan<T> destination) => _shape.TryCopyTo(ref _reference, destination);

        /// <inheritdoc cref="IReadOnlyTensor{TSelf, T}.TryFlattenTo(Span{T})" />
        public bool TryFlattenTo(scoped Span<T> destination) => _shape.TryFlattenTo(ref _reference, destination);
