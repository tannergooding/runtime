...
namespace System.Numerics.Tensors
{
...
#endif
    {
        ...
        {
            _shape = TensorShape.Create(ref data, dataLength, lengths, strides, pinned: false);
            _reference = ref data;
        }
        ...
        MemoryHandle IReadOnlyTensor.GetPinnedHandle() => throw new NotImplementedException();
        ...
        bool ITensor.IsReadOnly => throw new NotImplementedException();

        object? ITensor.this[params scoped ReadOnlySpan<NIndex> indexes] { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        object? ITensor.this[params scoped ReadOnlySpan<nint> indexes] { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }

        void ITensor.Fill(object value) => throw new NotImplementedException();

        //
        // ITensor<TSelf, T>
        //

        static TensorSpan<T> ITensor<TensorSpan<T>, T>.Create(scoped ReadOnlySpan<nint> lengths, bool pinned) => throw new NotImplementedException();
        static TensorSpan<T> ITensor<TensorSpan<T>, T>.Create(scoped ReadOnlySpan<nint> lengths, scoped ReadOnlySpan<nint> strides, bool pinned) => throw new NotImplementedException();
        static TensorSpan<T> ITensor<TensorSpan<T>, T>.CreateUninitialized(scoped ReadOnlySpan<nint> lengths, bool pinned) => throw new NotImplementedException();
        static TensorSpan<T> ITensor<TensorSpan<T>, T>.CreateUninitialized(scoped ReadOnlySpan<nint> lengths, scoped ReadOnlySpan<nint> strides, bool pinned) => throw new NotImplementedException();
        TensorSpan<T> ITensor<TensorSpan<T>, T>.AsTensorSpan() => throw new NotImplementedException();
        TensorSpan<T> ITensor<TensorSpan<T>, T>.AsTensorSpan(params scoped ReadOnlySpan<nint> startIndexes) => throw new NotImplementedException();
        TensorSpan<T> ITensor<TensorSpan<T>, T>.AsTensorSpan(params scoped ReadOnlySpan<NIndex> startIndexes) => throw new NotImplementedException();
        TensorSpan<T> ITensor<TensorSpan<T>, T>.AsTensorSpan(params scoped ReadOnlySpan<NRange> ranges) => throw new NotImplementedException();
#endif
