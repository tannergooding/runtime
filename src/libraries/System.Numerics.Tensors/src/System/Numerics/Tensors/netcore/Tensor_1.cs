...
namespace System.Numerics.Tensors
{
    ...
    public sealed class Tensor<T> : ITensor<Tensor<T>, T>
    {
        ...
        /// <inheritdoc cref="TensorSpan{T}.implicit operator ReadOnlyTensorSpan{T}(TensorSpan{T})" />
        ...
        public ReadOnlyTensorSpan<T> AsReadOnlyTensorSpan(params scoped ReadOnlySpan<NRange> range) => AsTensorSpan().Slice(range);
        ...
        public unsafe void Clear() => _shape.Clear(ref MemoryMarshal.GetArrayDataReference(_values));

        /// <inheritdoc cref="IReadOnlyTensor{TSelf, T}.CopyTo(TensorSpan{T})" />
        ...
        public void Fill(T value) => _shape.Fill(ref MemoryMarshal.GetArrayDataReference(_values), value);
        ...
        /// <inheritdoc cref="IReadOnlyTensor{TSelf, T}.TryCopyTo(TensorSpan{T})" />
        public bool TryCopyTo(scoped TensorSpan<T> destination) => _shape.TryCopyTo(ref MemoryMarshal.GetArrayDataReference(_values), destination);

        /// <inheritdoc cref="IReadOnlyTensor{TSelf, T}.TryFlattenTo(Span{T})" />
        public bool TryFlattenTo(scoped Span<T> destination) => _shape.TryFlattenTo(ref MemoryMarshal.GetArrayDataReference(_values), destination);
        ...
        private struct Enumerator : IEnumerator<T>
        {
            ...
            public bool MoveNext()
            {
                ...
                TensorShape.AdjustToNextIndex(_indexes, _tensor.Lengths);
                _linearOffset = _tensor._shape.GetLinearOffset<TensorShape.GetOffsetAndLengthForNInt, nint>(_indexes);
