...
namespace System.Threading.Tasks
{
    ...
    public class TaskFactory
    {
        ...
        internal static void CheckFromAsyncOptions(TaskCreationOptions creationOptions, bool hasBeginMethod)
        {
            if (hasBeginMethod)
            {
                ...
                if ((creationOptions & TaskCreationOptions.LongRunning) != 0)
                    throw new ArgumentOutOfRangeException(nameof(creationOptions), SR.GetResourceString("Task_FromAsync_LongRunning"));
                if ((creationOptions & TaskCreationOptions.PreferFairness) != 0)
                    throw new ArgumentOutOfRangeException(nameof(creationOptions), SR.GetResourceString("Task_FromAsync_PreferFairness"));
            }
        ...
        internal static Task<Task> CommonCWAnyLogic(IList<Task> tasks, bool isSyncBlocking = false)
        {
            ...
            {
                Task task = tasks[i];
                if (task == null) throw new ArgumentException(SR.GetResourceString("Task_MultiTaskContinuation_NullTask"), nameof(tasks));
        ...
        internal static Task[] CheckMultiContinuationTasksAndCopy(Task[] tasks)
        {
            ...
            if (tasks.Length == 0)
                throw new ArgumentException(SR.GetResourceString("Task_MultiTaskContinuation_EmptyTaskList"), nameof(tasks));
            ...
            for (int i = 0; i < tasks.Length; i++)
            {
                ...
                if (tasksCopy[i] == null)
                    throw new ArgumentException(SR.GetResourceString("Task_MultiTaskContinuation_NullTask"), nameof(tasks));
            }
        ...
        internal static void CheckMultiTaskContinuationOptions(TaskContinuationOptions continuationOptions)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(continuationOptions), SR.GetResourceString("Task_ContinueWith_ESandLR"));
            }
            ...
            if ((continuationOptions & NotOnAny) != 0)
                throw new ArgumentOutOfRangeException(nameof(continuationOptions), SR.GetResourceString("Task_MultiTaskContinuation_FireOptions"));
        }
    }
}
