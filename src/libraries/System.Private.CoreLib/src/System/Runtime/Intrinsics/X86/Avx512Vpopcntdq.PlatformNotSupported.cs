...
namespace System.Runtime.Intrinsics.X86
{
    ...
    public abstract class Avx512Vpopcntdq : Avx512DQ
    {
        ...
        public new abstract class VL : Avx512DQ.VL
        {
            ...
            /// </summary>
            public static Vector128<int> PopCount(Vector128<int> value) { throw new PlatformNotSupportedException(); }
            /// <summary>
            ///   <para>__m128i _mm_popcnt_epi32 (__m128i a)</para>
            ///   <para>  VPOPCNTD xmm1 {k1}{z}, xmm2/m128/m32bcst</para>
            /// </summary>
            public static Vector128<uint> PopCount(Vector128<uint> value) { throw new PlatformNotSupportedException(); }
            /// <summary>
            ///   <para>__m128i _mm_popcnt_epi64 (__m128i a)</para>
            ///   <para>  VPOPCNTQ xmm1 {k1}{z}, xmm2/m128/m64bcst</para>
            /// </summary>
            public static Vector128<long> PopCount(Vector128<long> value) { throw new PlatformNotSupportedException(); }
            /// <summary>
            ///   <para>__m128i _mm_popcnt_epi64 (__m128i a)</para>
            ///   <para>  VPOPCNTQ xmm1 {k1}{z}, xmm2/m128/m64bcst</para>
            /// </summary>
            public static Vector128<ulong> PopCount(Vector128<ulong> value) { throw new PlatformNotSupportedException(); }
        ...
        /// </summary>
        public static Vector512<int> PopCount(Vector512<int> value) { throw new PlatformNotSupportedException(); }
        /// <summary>
        ///   <para>__m512i _mm512_popcnt_epi32 (__m512i a)</para>
        ///   <para>  VPOPCNTD zmm1 {k1}{z}, zmm2/m512/m32bcst</para>
        /// </summary>
        public static Vector512<uint> PopCount(Vector512<uint> value) { throw new PlatformNotSupportedException(); }
        /// <summary>
        ///   <para>__m512i _mm512_popcnt_epi64 (__m512i a)</para>
        ///   <para>  VPOPCNTQ zmm1 {k1}{z}, zmm2/m512/m64bcst</para>
        /// </summary>
        public static Vector512<long> PopCount(Vector512<long> value) { throw new PlatformNotSupportedException(); }
        /// <summary>
        ///   <para>__m512i _mm512_popcnt_epi64 (__m512i a)</para>
        ///   <para>  VPOPCNTQ zmm1 {k1}{z}, zmm2/m512/m64bcst</para>
        /// </summary>
        public static Vector512<ulong> PopCount(Vector512<ulong> value) { throw new PlatformNotSupportedException(); }
    }
}
