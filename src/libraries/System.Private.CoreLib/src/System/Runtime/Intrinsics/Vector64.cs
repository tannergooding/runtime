...
public static unsafe class Vector64
{
    ...
    /// <remarks>64-bit vector operations are subject to hardware acceleration on systems that support Single Instruction, Multiple Data (SIMD) instructions for 64-bit vectors.</remarks>
    ...
    /// <param name="right">The vector that is ones-complemented before being bitwise-and with <paramref name="left" />.</param>
        ...
        where T : struct
    {
        ...
        ulong result = left._00 & ~right._00;
        return Unsafe.BitCast<ulong, Vector64<T>>(result);
    }
    ...
    {
        ThrowHelper.ThrowForUnsupportedIntrinsicsVector64BaseType<T>();
        ulong result = (left._00 & condition._00) | (right._00 & ~condition._00);
        return Unsafe.BitCast<ulong, Vector64<T>>(result);
    }
        ...
        where T : struct
    {
        ...
        return Unsafe.ReadUnaligned<Vector64<T>>(ref address);
    }
