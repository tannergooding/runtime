...
namespace System.Reflection
{
    public abstract partial class FieldInfo : MemberInfo
    {
        ...
        [CLSCompliant(false)]
        public virtual void SetValueDirect(TypedReference obj, object value) { throw new NotSupportedException(SR.GetResourceString("NotSupported_AbstractNonCLS")); }
        [CLSCompliant(false)]
        public virtual object? GetValueDirect(TypedReference obj) { throw new NotSupportedException(SR.GetResourceString("NotSupported_AbstractNonCLS")); }

        public virtual object? GetRawConstantValue() { throw new NotSupportedException(SR.GetResourceString("NotSupported_AbstractNonCLS")); }
