...
namespace System
{
    ...
    public readonly struct UInt32 : IComparable, IConvertible, IFormattable, IComparable<uint>, IEquatable<uint>, ISpanFormattable
    {
        ...
        public int CompareTo(object? value)
        {
            ...
            throw new ArgumentException(SR.GetResourceString("Arg_MustBeUInt32"));
        }
        ...
        {
            throw new InvalidCastException(SR.Format(SR.GetResourceString("InvalidCast_FromTo"), "UInt32", "DateTime"));
        }
