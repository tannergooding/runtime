...
namespace System.Tests
{
    public class Decimal64Tests
    {
        ...
        private static void AssertIntelClose(double expected, Decimal64 actual)
        {
        ...
        [ConditionalTheory(typeof(DecimalIeee754IntelTestData), nameof(DecimalIeee754IntelTestData.IsAvailable))]
        [MemberData(nameof(DecimalIeee754IntelTestData.Decimal64TranscendentalUnary), MemberType = typeof(DecimalIeee754IntelTestData))]
        public static void TranscendentalUnary_IntelReferenceVectors(string operation, ulong value, ulong expected)
        {
            Decimal64 x = Unsafe.BitCast<ulong, Decimal64>(value);

            double operandDouble = (double)x;
            double expectedDouble = (double)Unsafe.BitCast<ulong, Decimal64>(expected);
            ...
            if ((operandDouble == 0) && (x != Decimal64.Zero))
            {
                return;
            }
            ...
            {
                "exp" => Decimal64.Exp(x),
                "exp2" => Decimal64.Exp2(x),
                "exp10" => Decimal64.Exp10(x),
                "expm1" => Decimal64.ExpM1(x),
                "log" => Decimal64.Log(x),
                "log2" => Decimal64.Log2(x),
                "log10" => Decimal64.Log10(x),
                "log1p" => Decimal64.LogP1(x),
                "cbrt" => Decimal64.Cbrt(x),
                "sin" => Decimal64.Sin(x),
                "cos" => Decimal64.Cos(x),
                "tan" => Decimal64.Tan(x),
                "asin" => Decimal64.Asin(x),
                "acos" => Decimal64.Acos(x),
                "atan" => Decimal64.Atan(x),
                "sinh" => Decimal64.Sinh(x),
                "cosh" => Decimal64.Cosh(x),
                "tanh" => Decimal64.Tanh(x),
                "asinh" => Decimal64.Asinh(x),
                "acosh" => Decimal64.Acosh(x),
                "atanh" => Decimal64.Atanh(x),
                _ => throw new InvalidOperationException($"Unexpected operation '{operation}'."),
            };
        ...
        [ConditionalTheory(typeof(DecimalIeee754IntelTestData), nameof(DecimalIeee754IntelTestData.IsAvailable))]
        [MemberData(nameof(DecimalIeee754IntelTestData.Decimal64TranscendentalBinary), MemberType = typeof(DecimalIeee754IntelTestData))]
        public static void TranscendentalBinary_IntelReferenceVectors(string operation, ulong left, ulong right, ulong expected)
        {
            Decimal64 l = Unsafe.BitCast<ulong, Decimal64>(left);
            Decimal64 r = Unsafe.BitCast<ulong, Decimal64>(right);
            ...
            if (((leftDouble == 0) && (l != Decimal64.Zero)) || ((rightDouble == 0) && (r != Decimal64.Zero)))
            {
                return;
            }
            ...
            Decimal64 result = operation switch
            {
                "pow" => Decimal64.Pow(l, r),
                "hypot" => Decimal64.Hypot(l, r),
                "atan2" => Decimal64.Atan2(l, r),
                _ => throw new InvalidOperationException($"Unexpected operation '{operation}'."),
            };
        ...
        {
            Assert.Equal(Decimal64.One, Decimal64.Pow(Decimal64.NaN, Decimal64.Zero));
            Assert.Equal(Decimal64.One, Decimal64.Pow(Decimal64.One, Decimal64.NaN));
            Assert.Equal(Decimal64.One, Decimal64.Pow(Decimal64.PositiveInfinity, Decimal64.Zero));
            Assert.True(Decimal64.IsNaN(Decimal64.Pow(Decimal64.NaN, (Decimal64)2.0)));
            Assert.Equal(Bits(Decimal64.PositiveInfinity), Bits(Decimal64.Pow(Decimal64.PositiveInfinity, (Decimal64)2.0)));

            AssertClose(8.0, Decimal64.Pow((Decimal64)2.0, (Decimal64)3.0), 1e-12);
            AssertClose(2.0, Decimal64.Pow((Decimal64)4.0, (Decimal64)0.5), 1e-12);
            AssertClose(-8.0, Decimal64.Pow((Decimal64)(-2.0), (Decimal64)3.0), 1e-12);
        }
        ...
        {
            Assert.True(Decimal64.IsNaN(Decimal64.Asin(Decimal64.NaN)));
            Assert.True(Decimal64.IsNaN(Decimal64.Asin((Decimal64)2.0)));
            Assert.Equal(Bits(Decimal64.Zero), Bits(Decimal64.Asin(Decimal64.Zero)));
            Assert.Equal(Bits(Decimal64.NegativeZero), Bits(Decimal64.Asin(Decimal64.NegativeZero)));

            AssertClose(double.Asin(0.5), Decimal64.Asin((Decimal64)0.5), 1e-12);
        }

        [Fact]
        public static void Acos()
        {
            Assert.True(Decimal64.IsNaN(Decimal64.Acos(Decimal64.NaN)));
            Assert.True(Decimal64.IsNaN(Decimal64.Acos((Decimal64)2.0)));
            Assert.Equal(Bits(Decimal64.Zero), Bits(Decimal64.Acos(Decimal64.One)));

            AssertClose(double.Acos(0.5), Decimal64.Acos((Decimal64)0.5), 1e-12);
        }

        [Fact]
        public static void Atan()
        {
            Assert.True(Decimal64.IsNaN(Decimal64.Atan(Decimal64.NaN)));
            Assert.Equal(Bits(Decimal64.Zero), Bits(Decimal64.Atan(Decimal64.Zero)));

            AssertClose(double.Atan(1.0), Decimal64.Atan(Decimal64.One), 1e-12);
            AssertClose(double.Atan(double.PositiveInfinity), Decimal64.Atan(Decimal64.PositiveInfinity), 1e-12);
        }

        [Fact]
        public static void AsinPi()
        {
            Assert.True(Decimal64.IsNaN(Decimal64.AsinPi(Decimal64.NaN)));
            Assert.Equal(Bits(Decimal64.Zero), Bits(Decimal64.AsinPi(Decimal64.Zero)));

            AssertClose(0.5, Decimal64.AsinPi(Decimal64.One), 1e-12);
        }

        [Fact]
        public static void AcosPi()
        {
            Assert.True(Decimal64.IsNaN(Decimal64.AcosPi(Decimal64.NaN)));
            Assert.Equal(Bits(Decimal64.Zero), Bits(Decimal64.AcosPi(Decimal64.One)));

            AssertClose(0.5, Decimal64.AcosPi(Decimal64.Zero), 1e-12);
        }

        [Fact]
        public static void AtanPi()
        {
            Assert.True(Decimal64.IsNaN(Decimal64.AtanPi(Decimal64.NaN)));
            Assert.Equal(Bits(Decimal64.Zero), Bits(Decimal64.AtanPi(Decimal64.Zero)));

            AssertClose(0.25, Decimal64.AtanPi(Decimal64.One), 1e-12);
        }

        [Fact]
        public static void Atan2()
        {
            Assert.True(Decimal64.IsNaN(Decimal64.Atan2(Decimal64.NaN, Decimal64.One)));
            Assert.Equal(Bits(Decimal64.Zero), Bits(Decimal64.Atan2(Decimal64.Zero, Decimal64.One)));

            AssertClose(double.Atan2(1.0, 1.0), Decimal64.Atan2(Decimal64.One, Decimal64.One), 1e-12);
        }

        [Fact]
        public static void Atan2Pi()
        {
            Assert.True(Decimal64.IsNaN(Decimal64.Atan2Pi(Decimal64.NaN, Decimal64.One)));
            Assert.Equal(Bits(Decimal64.Zero), Bits(Decimal64.Atan2Pi(Decimal64.Zero, Decimal64.One)));
