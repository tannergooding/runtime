...
namespace JIT.HardwareIntrinsics.General
{
    ...
    {
        private static void AllBitsSetUInt64()
        {
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetUInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<UInt64> result = Vector512<UInt64>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512<UInt64>)
                                .GetProperty(nameof(Vector512<UInt64>.AllBitsSet), new Type[] { })
                                .GetGetMethod()
                                .Invoke(null, new object[] { });

            ValidateResult((Vector512<UInt64>)(result));
        }

        private void ValidateResult(Vector512<UInt64> result, [CallerMemberName] string method = "")
        {
        ...
        private unsafe void ValidateResult(UInt64[] resultElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.AllBitsSet(UInt64): {method} failed:");
