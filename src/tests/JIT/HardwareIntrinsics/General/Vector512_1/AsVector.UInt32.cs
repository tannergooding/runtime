...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsVectorUInt32
    {
        ...
        private static readonly int VectorElementCount = Unsafe.SizeOf<Vector512<UInt32>>() / sizeof(UInt32);
        ...
        public void RunReflectionScenario()
        {
            ...
            value = (Vector512<UInt32>)typeof(Vector512)
                                .GetMethods()
                                .Where((methodInfo) => {
        ...
        private void ValidateResult(Vector<UInt32> result, Vector512<UInt32> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Vector512<UInt32> result, Vector<UInt32> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] resultElements, UInt32[] valueElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512<UInt32>.AsVector: {method} failed:");
