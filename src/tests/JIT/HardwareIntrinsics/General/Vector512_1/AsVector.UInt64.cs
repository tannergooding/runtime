...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsVectorUInt64
    {
        ...
        private static readonly int VectorElementCount = Unsafe.SizeOf<Vector512<UInt64>>() / sizeof(UInt64);
        ...
        public void RunReflectionScenario()
        {
            ...
            value = (Vector512<UInt64>)typeof(Vector512)
                                .GetMethods()
                                .Where((methodInfo) => {
        ...
        private void ValidateResult(Vector<UInt64> result, Vector512<UInt64> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Vector512<UInt64> result, Vector<UInt64> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt64[] resultElements, UInt64[] valueElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512<UInt64>.AsVector: {method} failed:");
