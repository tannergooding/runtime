...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetSingle
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Single> result = Vector512<Single>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512<Single>)
                                .GetProperty(nameof(Vector512<Single>.AllBitsSet), new Type[] { })
                                .GetGetMethod()
                                .Invoke(null, new object[] { });

            ValidateResult((Vector512<Single>)(result));
        }

        private void ValidateResult(Vector512<Single> result, [CallerMemberName] string method = "")
        {
        ...
        private unsafe void ValidateResult(Single[] resultElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.AllBitsSet(Single): {method} failed:");
