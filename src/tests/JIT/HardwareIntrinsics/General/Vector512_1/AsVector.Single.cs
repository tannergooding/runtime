...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsVectorSingle
    {
        ...
        private static readonly int VectorElementCount = Unsafe.SizeOf<Vector512<Single>>() / sizeof(Single);
        ...
        public void RunReflectionScenario()
        {
            ...
            value = (Vector512<Single>)typeof(Vector512)
                                .GetMethods()
                                .Where((methodInfo) => {
        ...
        private void ValidateResult(Vector<Single> result, Vector512<Single> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Vector512<Single> result, Vector<Single> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Single[] resultElements, Single[] valueElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512<Single>.AsVector: {method} failed:");
