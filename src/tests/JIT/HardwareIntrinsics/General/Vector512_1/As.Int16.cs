...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsInt16
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int16> value;

            value = Vector512.Create((short)TestLibrary.Generator.GetInt16());
        ...
        public void RunGenericScenario()
        {
            ...
            value = Vector512.Create((short)TestLibrary.Generator.GetInt16());
            Vector512<byte> byteResult = value.As<Int16, byte>();
            ValidateResult(byteResult, value);

            value = Vector512.Create((short)TestLibrary.Generator.GetInt16());
            Vector512<double> doubleResult = value.As<Int16, double>();
            ValidateResult(doubleResult, value);

            value = Vector512.Create((short)TestLibrary.Generator.GetInt16());
            Vector512<short> shortResult = value.As<Int16, short>();
            ValidateResult(shortResult, value);

            value = Vector512.Create((short)TestLibrary.Generator.GetInt16());
            Vector512<int> intResult = value.As<Int16, int>();
            ValidateResult(intResult, value);

            value = Vector512.Create((short)TestLibrary.Generator.GetInt16());
            Vector512<long> longResult = value.As<Int16, long>();
            ValidateResult(longResult, value);

            value = Vector512.Create((short)TestLibrary.Generator.GetInt16());
            Vector512<sbyte> sbyteResult = value.As<Int16, sbyte>();
            ValidateResult(sbyteResult, value);

            value = Vector512.Create((short)TestLibrary.Generator.GetInt16());
            Vector512<float> floatResult = value.As<Int16, float>();
            ValidateResult(floatResult, value);

            value = Vector512.Create((short)TestLibrary.Generator.GetInt16());
            Vector512<ushort> ushortResult = value.As<Int16, ushort>();
            ValidateResult(ushortResult, value);

            value = Vector512.Create((short)TestLibrary.Generator.GetInt16());
            Vector512<uint> uintResult = value.As<Int16, uint>();
            ValidateResult(uintResult, value);

            value = Vector512.Create((short)TestLibrary.Generator.GetInt16());
            Vector512<ulong> ulongResult = value.As<Int16, ulong>();
            ValidateResult(ulongResult, value);
        }
        ...
        private void ValidateResult<T>(Vector512<T> result, Vector512<Int16> value, [CallerMemberName] string method = "")
            where T : struct
        {
        ...
        private void ValidateResult(Int16[] resultElements, Int16[] valueElements, Type targetType, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512<Int16>.As{targetType.Name}: {method} failed:");
