...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsUInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            value = Vector512.Create((ulong)TestLibrary.Generator.GetUInt64());
        ...
        public void RunGenericScenario()
        {
            ...
            value = Vector512.Create((ulong)TestLibrary.Generator.GetUInt64());
            Vector512<byte> byteResult = value.As<UInt64, byte>();
            ValidateResult(byteResult, value);

            value = Vector512.Create((ulong)TestLibrary.Generator.GetUInt64());
            Vector512<double> doubleResult = value.As<UInt64, double>();
            ValidateResult(doubleResult, value);

            value = Vector512.Create((ulong)TestLibrary.Generator.GetUInt64());
            Vector512<short> shortResult = value.As<UInt64, short>();
            ValidateResult(shortResult, value);

            value = Vector512.Create((ulong)TestLibrary.Generator.GetUInt64());
            Vector512<int> intResult = value.As<UInt64, int>();
            ValidateResult(intResult, value);

            value = Vector512.Create((ulong)TestLibrary.Generator.GetUInt64());
            Vector512<long> longResult = value.As<UInt64, long>();
            ValidateResult(longResult, value);

            value = Vector512.Create((ulong)TestLibrary.Generator.GetUInt64());
            Vector512<sbyte> sbyteResult = value.As<UInt64, sbyte>();
            ValidateResult(sbyteResult, value);

            value = Vector512.Create((ulong)TestLibrary.Generator.GetUInt64());
            Vector512<float> floatResult = value.As<UInt64, float>();
            ValidateResult(floatResult, value);

            value = Vector512.Create((ulong)TestLibrary.Generator.GetUInt64());
            Vector512<ushort> ushortResult = value.As<UInt64, ushort>();
            ValidateResult(ushortResult, value);

            value = Vector512.Create((ulong)TestLibrary.Generator.GetUInt64());
            Vector512<uint> uintResult = value.As<UInt64, uint>();
            ValidateResult(uintResult, value);

            value = Vector512.Create((ulong)TestLibrary.Generator.GetUInt64());
            Vector512<ulong> ulongResult = value.As<UInt64, ulong>();
            ValidateResult(ulongResult, value);
        }
        ...
        private void ValidateResult<T>(Vector512<T> result, Vector512<UInt64> value, [CallerMemberName] string method = "")
            where T : struct
        {
        ...
        private void ValidateResult(UInt64[] resultElements, UInt64[] valueElements, Type targetType, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512<UInt64>.As{targetType.Name}: {method} failed:");
