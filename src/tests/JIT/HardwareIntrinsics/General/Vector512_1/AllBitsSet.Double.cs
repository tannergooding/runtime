...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetDouble
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Double> result = Vector512<Double>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512<Double>)
                                .GetProperty(nameof(Vector512<Double>.AllBitsSet), new Type[] { })
                                .GetGetMethod()
                                .Invoke(null, new object[] { });

            ValidateResult((Vector512<Double>)(result));
        }

        private void ValidateResult(Vector512<Double> result, [CallerMemberName] string method = "")
        {
        ...
        private unsafe void ValidateResult(Double[] resultElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.AllBitsSet(Double): {method} failed:");
