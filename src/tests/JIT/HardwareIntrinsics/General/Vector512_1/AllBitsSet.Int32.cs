...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetInt32
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int32> result = Vector512<Int32>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512<Int32>)
                                .GetProperty(nameof(Vector512<Int32>.AllBitsSet), new Type[] { })
                                .GetGetMethod()
                                .Invoke(null, new object[] { });

            ValidateResult((Vector512<Int32>)(result));
        }

        private void ValidateResult(Vector512<Int32> result, [CallerMemberName] string method = "")
        {
        ...
        private unsafe void ValidateResult(Int32[] resultElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.AllBitsSet(Int32): {method} failed:");
