...
namespace JIT.HardwareIntrinsics.General
{
    public static partial class Program
    {
        ...
        {
            int size = Unsafe.SizeOf<Vector512<Double>>() / sizeof(Double);
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512DoubleToString: Vector512<Double>.ToString() returned an unexpected result.");
