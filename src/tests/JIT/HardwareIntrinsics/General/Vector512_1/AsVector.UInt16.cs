...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsVectorUInt16
    {
        ...
        private static readonly int VectorElementCount = Unsafe.SizeOf<Vector512<UInt16>>() / sizeof(UInt16);
        ...
        public void RunReflectionScenario()
        {
            ...
            value = (Vector512<UInt16>)typeof(Vector512)
                                .GetMethods()
                                .Where((methodInfo) => {
        ...
        private void ValidateResult(Vector<UInt16> result, Vector512<UInt16> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Vector512<UInt16> result, Vector<UInt16> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt16[] resultElements, UInt16[] valueElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512<UInt16>.AsVector: {method} failed:");
