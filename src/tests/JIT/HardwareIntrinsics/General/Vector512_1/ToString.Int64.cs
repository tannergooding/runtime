...
namespace JIT.HardwareIntrinsics.General
{
    public static partial class Program
    {
        ...
        {
            int size = Unsafe.SizeOf<Vector512<Int64>>() / sizeof(Int64);
            ...
            Vector512<Int64> vector = Vector512.Create(values[0], values[1], values[2], values[3]);
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512Int64ToString: Vector512<Int64>.ToString() returned an unexpected result.");
