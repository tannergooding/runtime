...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorZero__ZeroInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int64> result = Vector512<Int64>.Zero;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512<Int64>)
                                .GetProperty(nameof(Vector512<Int64>.Zero), new Type[] { })
                                .GetGetMethod()
        ...
        private void ValidateResult(Int64[] resultElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.Zero(Int64): {method} failed:");
