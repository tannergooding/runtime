...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int64> value;

            value = Vector512.Create((long)TestLibrary.Generator.GetInt64());
        ...
        public void RunGenericScenario()
        {
            ...
            value = Vector512.Create((long)TestLibrary.Generator.GetInt64());
            Vector512<byte> byteResult = value.As<Int64, byte>();
            ValidateResult(byteResult, value);

            value = Vector512.Create((long)TestLibrary.Generator.GetInt64());
            Vector512<double> doubleResult = value.As<Int64, double>();
            ValidateResult(doubleResult, value);

            value = Vector512.Create((long)TestLibrary.Generator.GetInt64());
            Vector512<short> shortResult = value.As<Int64, short>();
            ValidateResult(shortResult, value);

            value = Vector512.Create((long)TestLibrary.Generator.GetInt64());
            Vector512<int> intResult = value.As<Int64, int>();
            ValidateResult(intResult, value);

            value = Vector512.Create((long)TestLibrary.Generator.GetInt64());
            Vector512<long> longResult = value.As<Int64, long>();
            ValidateResult(longResult, value);

            value = Vector512.Create((long)TestLibrary.Generator.GetInt64());
            Vector512<sbyte> sbyteResult = value.As<Int64, sbyte>();
            ValidateResult(sbyteResult, value);

            value = Vector512.Create((long)TestLibrary.Generator.GetInt64());
            Vector512<float> floatResult = value.As<Int64, float>();
            ValidateResult(floatResult, value);

            value = Vector512.Create((long)TestLibrary.Generator.GetInt64());
            Vector512<ushort> ushortResult = value.As<Int64, ushort>();
            ValidateResult(ushortResult, value);

            value = Vector512.Create((long)TestLibrary.Generator.GetInt64());
            Vector512<uint> uintResult = value.As<Int64, uint>();
            ValidateResult(uintResult, value);

            value = Vector512.Create((long)TestLibrary.Generator.GetInt64());
            Vector512<ulong> ulongResult = value.As<Int64, ulong>();
            ValidateResult(ulongResult, value);
        }
        ...
        private void ValidateResult<T>(Vector512<T> result, Vector512<Int64> value, [CallerMemberName] string method = "")
            where T : struct
        {
        ...
        private void ValidateResult(Int64[] resultElements, Int64[] valueElements, Type targetType, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512<Int64>.As{targetType.Name}: {method} failed:");
