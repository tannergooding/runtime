...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsVectorInt32
    {
        ...
        private static readonly int VectorElementCount = Unsafe.SizeOf<Vector512<Int32>>() / sizeof(Int32);
        ...
        public void RunReflectionScenario()
        {
            ...
            value = (Vector512<Int32>)typeof(Vector512)
                                .GetMethods()
                                .Where((methodInfo) => {
        ...
        private void ValidateResult(Vector<Int32> result, Vector512<Int32> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Vector512<Int32> result, Vector<Int32> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] resultElements, Int32[] valueElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512<Int32>.AsVector: {method} failed:");
