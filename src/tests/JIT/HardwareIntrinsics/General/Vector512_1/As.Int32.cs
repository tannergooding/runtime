...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsInt32
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int32> value;

            value = Vector512.Create((int)TestLibrary.Generator.GetInt32());
        ...
        public void RunGenericScenario()
        {
            ...
            value = Vector512.Create((int)TestLibrary.Generator.GetInt32());
            Vector512<byte> byteResult = value.As<Int32, byte>();
            ValidateResult(byteResult, value);

            value = Vector512.Create((int)TestLibrary.Generator.GetInt32());
            Vector512<double> doubleResult = value.As<Int32, double>();
            ValidateResult(doubleResult, value);

            value = Vector512.Create((int)TestLibrary.Generator.GetInt32());
            Vector512<short> shortResult = value.As<Int32, short>();
            ValidateResult(shortResult, value);

            value = Vector512.Create((int)TestLibrary.Generator.GetInt32());
            Vector512<int> intResult = value.As<Int32, int>();
            ValidateResult(intResult, value);

            value = Vector512.Create((int)TestLibrary.Generator.GetInt32());
            Vector512<long> longResult = value.As<Int32, long>();
            ValidateResult(longResult, value);

            value = Vector512.Create((int)TestLibrary.Generator.GetInt32());
            Vector512<sbyte> sbyteResult = value.As<Int32, sbyte>();
            ValidateResult(sbyteResult, value);

            value = Vector512.Create((int)TestLibrary.Generator.GetInt32());
            Vector512<float> floatResult = value.As<Int32, float>();
            ValidateResult(floatResult, value);

            value = Vector512.Create((int)TestLibrary.Generator.GetInt32());
            Vector512<ushort> ushortResult = value.As<Int32, ushort>();
            ValidateResult(ushortResult, value);

            value = Vector512.Create((int)TestLibrary.Generator.GetInt32());
            Vector512<uint> uintResult = value.As<Int32, uint>();
            ValidateResult(uintResult, value);

            value = Vector512.Create((int)TestLibrary.Generator.GetInt32());
            Vector512<ulong> ulongResult = value.As<Int32, ulong>();
            ValidateResult(ulongResult, value);
        }
        ...
        private void ValidateResult<T>(Vector512<T> result, Vector512<Int32> value, [CallerMemberName] string method = "")
            where T : struct
        {
        ...
        private void ValidateResult(Int32[] resultElements, Int32[] valueElements, Type targetType, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512<Int32>.As{targetType.Name}: {method} failed:");
