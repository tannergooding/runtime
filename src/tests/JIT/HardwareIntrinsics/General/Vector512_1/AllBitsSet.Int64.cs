...
namespace JIT.HardwareIntrinsics.General
{
    ...
    {
        private static void AllBitsSetInt64()
        {
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int64> result = Vector512<Int64>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512<Int64>)
                                .GetProperty(nameof(Vector512<Int64>.AllBitsSet), new Type[] { })
                                .GetGetMethod()
                                .Invoke(null, new object[] { });

            ValidateResult((Vector512<Int64>)(result));
        }

        private void ValidateResult(Vector512<Int64> result, [CallerMemberName] string method = "")
        {
        ...
        private unsafe void ValidateResult(Int64[] resultElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.AllBitsSet(Int64): {method} failed:");
