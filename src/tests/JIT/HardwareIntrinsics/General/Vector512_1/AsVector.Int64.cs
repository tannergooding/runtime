...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAs__AsVectorInt64
    {
        ...
        private static readonly int VectorElementCount = Unsafe.SizeOf<Vector512<Int64>>() / sizeof(Int64);
        ...
        public void RunReflectionScenario()
        {
            ...
            value = (Vector512<Int64>)typeof(Vector512)
                                .GetMethods()
                                .Where((methodInfo) => {
        ...
        private void ValidateResult(Vector<Int64> result, Vector512<Int64> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Vector512<Int64> result, Vector<Int64> value, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] resultElements, Int64[] valueElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512<Int64>.AsVector: {method} failed:");
