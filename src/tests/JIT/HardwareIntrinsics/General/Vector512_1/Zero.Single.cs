...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorZero__ZeroSingle
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Single> result = Vector512<Single>.Zero;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512<Single>)
                                .GetProperty(nameof(Vector512<Single>.Zero), new Type[] { })
                                .GetGetMethod()
        ...
        private void ValidateResult(Single[] resultElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.Zero(Single): {method} failed:");
