...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorAllBitsSet__AllBitsSetByte
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Byte> result = Vector512<Byte>.AllBitsSet;
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512<Byte>)
                                .GetProperty(nameof(Vector512<Byte>.AllBitsSet), new Type[] { })
                                .GetGetMethod()
                                .Invoke(null, new object[] { });

            ValidateResult((Vector512<Byte>)(result));
        }

        private void ValidateResult(Vector512<Byte> result, [CallerMemberName] string method = "")
        {
        ...
        private unsafe void ValidateResult(Byte[] resultElements, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.AllBitsSet(Byte): {method} failed:");
