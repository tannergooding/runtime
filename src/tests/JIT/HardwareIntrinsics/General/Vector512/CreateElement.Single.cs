...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateElementSingle
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Single> result = Vector512.Create(values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7]);
        ...
        public void RunReflectionScenario()
        {
            ...
            ValidateResult((Vector512<Single>)(result), values);
        }

        private void ValidateResult(Vector512<Single> result, Single[] expectedValues, [CallerMemberName] string method = "")
        {
