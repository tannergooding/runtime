...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateElementUInt16
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<UInt16> result = Vector512.Create(values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7], values[8], values[9], values[10], values[11], values[12], values[13], values[14], values[15]);
        ...
        public void RunReflectionScenario()
        {
            ...
            ValidateResult((Vector512<UInt16>)(result), values);
        }

        private void ValidateResult(Vector512<UInt16> result, UInt16[] expectedValues, [CallerMemberName] string method = "")
        {
