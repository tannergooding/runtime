...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateVectorInt32
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector256<Int32> lower = Vector256.Create(lowerValue);

            Int32 upperValue = TestLibrary.Generator.GetInt32();
            Vector256<Int32> upper = Vector256.Create(upperValue);

            Vector512<Int32> result = Vector512.Create(lower, upper);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.Create), new Type[] { typeof(Vector256<Int32>), typeof(Vector256<Int32>) })
                                .Invoke(null, new object[] { lower, upper });

            ValidateResult((Vector512<Int32>)(result), lowerValue, upperValue);
        }

        private void ValidateResult(Vector512<Int32> result, Int32 expectedLowerValue, Int32 expectedUpperValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] resultElements, Int32 expectedLowerValue, Int32 expectedUpperValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.Create(Int32): {method} failed:");
