...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateScalarUnsafeSByte
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<SByte> result = Vector512.CreateScalarUnsafe(value);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.CreateScalarUnsafe), new Type[] { typeof(SByte) })
                                .Invoke(null, new object[] { value });

            ValidateResult((Vector512<SByte>)(result), value);
        }

        private void ValidateResult(Vector512<SByte> result, SByte expectedValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(SByte[] resultElements, SByte expectedValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.CreateScalarUnsafe(SByte): {method} failed:");
