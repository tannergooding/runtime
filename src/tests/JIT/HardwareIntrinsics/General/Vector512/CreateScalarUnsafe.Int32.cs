...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateScalarUnsafeInt32
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int32> result = Vector512.CreateScalarUnsafe(value);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.CreateScalarUnsafe), new Type[] { typeof(Int32) })
                                .Invoke(null, new object[] { value });

            ValidateResult((Vector512<Int32>)(result), value);
        }

        private void ValidateResult(Vector512<Int32> result, Int32 expectedValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int32[] resultElements, Int32 expectedValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.CreateScalarUnsafe(Int32): {method} failed:");
