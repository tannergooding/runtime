...
namespace JIT.HardwareIntrinsics.General
{
    ...
    {
        private static void WidenUInt64()
        {
    ...
    public sealed unsafe class VectorWidenTest__WidenUInt64
    {
        ...
        private struct TestStruct
        {
            ...
            {
                var result = Vector512.Widen(_fld1);
        ...
        public void RunReflectionScenario_UnsafeRead()
        {
            ...
            var method = typeof(Vector512).GetMethod(nameof(Vector512.Widen), new Type[] {
                typeof(Vector512<UInt32>)
            });

            if (method is null)
            {
                method = typeof(Vector512).GetMethod(nameof(Vector512.Widen), 1, new Type[] {
            ...
            Unsafe.Write(_dataTable.outLowerArrayPtr, (((Vector512<UInt64> Lower, Vector512<UInt64> Upper))(result)).Lower);
            Unsafe.Write(_dataTable.outUpperArrayPtr, (((Vector512<UInt64> Lower, Vector512<UInt64> Upper))(result)).Upper);
            ValidateResult(_dataTable.inArray1Ptr, _dataTable.outLowerArrayPtr, _dataTable.outUpperArrayPtr);
        }
        ...
        public void RunLclVarScenario_UnsafeRead()
        {
            ...
            var result = Vector512.Widen(op1);
        ...
        public void RunClassLclFldScenario()
        {
            ...
            var test = new VectorWidenTest__WidenUInt64();
            var result = Vector512.Widen(test._fld1);
        ...
        private void ValidateResult(Vector512<UInt32> op1, void* lowerResult, void* upperResult, [CallerMemberName] string method = "")
        {
            ...
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<UInt64, byte>(ref outLowerArray[0]), ref Unsafe.AsRef<byte>(lowerResult), (uint)Unsafe.SizeOf<Vector512<UInt64>>());
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<UInt64, byte>(ref outUpperArray[0]), ref Unsafe.AsRef<byte>(upperResult), (uint)Unsafe.SizeOf<Vector512<UInt64>>());
        ...
        private void ValidateResult(UInt32[] firstOp, UInt64[] lowerResult, UInt64[] upperResult, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"{nameof(Vector512)}.{nameof(Vector512.Widen)}<UInt64>(Vector512<UInt32>): {method} failed:");
