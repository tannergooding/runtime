...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateScalarUnsafeInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int64> result = Vector512.CreateScalarUnsafe(value);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.CreateScalarUnsafe), new Type[] { typeof(Int64) })
                                .Invoke(null, new object[] { value });

            ValidateResult((Vector512<Int64>)(result), value);
        }

        private void ValidateResult(Vector512<Int64> result, Int64 expectedValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] resultElements, Int64 expectedValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.CreateScalarUnsafe(Int64): {method} failed:");
