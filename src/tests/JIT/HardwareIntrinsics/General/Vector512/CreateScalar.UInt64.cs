...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateScalarUInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<UInt64> result = Vector512.CreateScalar(value);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.CreateScalar), new Type[] { typeof(UInt64) })
        ...
        private void ValidateResult(UInt64[] resultElements, UInt64 expectedValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.CreateScalar(UInt64): {method} failed:");
