...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateElementUInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<UInt64> result = Vector512.Create(values[0], values[1], values[2], values[3]);
        ...
        public void RunReflectionScenario()
        {
            ...
            ValidateResult((Vector512<UInt64>)(result), values);
        }

        private void ValidateResult(Vector512<UInt64> result, UInt64[] expectedValues, [CallerMemberName] string method = "")
        {
