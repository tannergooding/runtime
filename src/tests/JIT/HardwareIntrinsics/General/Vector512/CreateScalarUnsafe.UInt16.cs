...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateScalarUnsafeUInt16
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<UInt16> result = Vector512.CreateScalarUnsafe(value);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.CreateScalarUnsafe), new Type[] { typeof(UInt16) })
                                .Invoke(null, new object[] { value });

            ValidateResult((Vector512<UInt16>)(result), value);
        }

        private void ValidateResult(Vector512<UInt16> result, UInt16 expectedValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt16[] resultElements, UInt16 expectedValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.CreateScalarUnsafe(UInt16): {method} failed:");
