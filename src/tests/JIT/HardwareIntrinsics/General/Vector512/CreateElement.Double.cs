...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateElementDouble
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Double> result = Vector512.Create(values[0], values[1], values[2], values[3]);
        ...
        public void RunReflectionScenario()
        {
            ...
            ValidateResult((Vector512<Double>)(result), values);
        }

        private void ValidateResult(Vector512<Double> result, Double[] expectedValues, [CallerMemberName] string method = "")
        {
