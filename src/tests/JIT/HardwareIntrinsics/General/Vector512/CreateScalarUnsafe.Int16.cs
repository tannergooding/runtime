...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateScalarUnsafeInt16
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int16> result = Vector512.CreateScalarUnsafe(value);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.CreateScalarUnsafe), new Type[] { typeof(Int16) })
                                .Invoke(null, new object[] { value });

            ValidateResult((Vector512<Int16>)(result), value);
        }

        private void ValidateResult(Vector512<Int16> result, Int16 expectedValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int16[] resultElements, Int16 expectedValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.CreateScalarUnsafe(Int16): {method} failed:");
