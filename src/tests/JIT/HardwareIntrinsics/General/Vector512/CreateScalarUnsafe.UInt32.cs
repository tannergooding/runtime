...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateScalarUnsafeUInt32
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<UInt32> result = Vector512.CreateScalarUnsafe(value);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.CreateScalarUnsafe), new Type[] { typeof(UInt32) })
                                .Invoke(null, new object[] { value });

            ValidateResult((Vector512<UInt32>)(result), value);
        }

        private void ValidateResult(Vector512<UInt32> result, UInt32 expectedValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt32[] resultElements, UInt32 expectedValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.CreateScalarUnsafe(UInt32): {method} failed:");
