...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateScalarUnsafeUInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<UInt64> result = Vector512.CreateScalarUnsafe(value);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.CreateScalarUnsafe), new Type[] { typeof(UInt64) })
                                .Invoke(null, new object[] { value });

            ValidateResult((Vector512<UInt64>)(result), value);
        }

        private void ValidateResult(Vector512<UInt64> result, UInt64 expectedValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(UInt64[] resultElements, UInt64 expectedValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.CreateScalarUnsafe(UInt64): {method} failed:");
