...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateScalarUnsafeByte
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Byte> result = Vector512.CreateScalarUnsafe(value);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.CreateScalarUnsafe), new Type[] { typeof(Byte) })
                                .Invoke(null, new object[] { value });

            ValidateResult((Vector512<Byte>)(result), value);
        }

        private void ValidateResult(Vector512<Byte> result, Byte expectedValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Byte[] resultElements, Byte expectedValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.CreateScalarUnsafe(Byte): {method} failed:");
