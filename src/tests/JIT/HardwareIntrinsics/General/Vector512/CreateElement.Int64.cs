...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateElementInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int64> result = Vector512.Create(values[0], values[1], values[2], values[3]);
        ...
        public void RunReflectionScenario()
        {
            ...
            ValidateResult((Vector512<Int64>)(result), values);
        }

        private void ValidateResult(Vector512<Int64> result, Int64[] expectedValues, [CallerMemberName] string method = "")
        {
