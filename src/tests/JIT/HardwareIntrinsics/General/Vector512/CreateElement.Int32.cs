...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateElementInt32
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int32> result = Vector512.Create(values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7]);
        ...
        public void RunReflectionScenario()
        {
            ...
            ValidateResult((Vector512<Int32>)(result), values);
        }

        private void ValidateResult(Vector512<Int32> result, Int32[] expectedValues, [CallerMemberName] string method = "")
        {
