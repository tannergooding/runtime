...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateVectorInt16
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector256<Int16> lower = Vector256.Create(lowerValue);

            Int16 upperValue = TestLibrary.Generator.GetInt16();
            Vector256<Int16> upper = Vector256.Create(upperValue);

            Vector512<Int16> result = Vector512.Create(lower, upper);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.Create), new Type[] { typeof(Vector256<Int16>), typeof(Vector256<Int16>) })
                                .Invoke(null, new object[] { lower, upper });

            ValidateResult((Vector512<Int16>)(result), lowerValue, upperValue);
        }

        private void ValidateResult(Vector512<Int16> result, Int16 expectedLowerValue, Int16 expectedUpperValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int16[] resultElements, Int16 expectedLowerValue, Int16 expectedUpperValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.Create(Int16): {method} failed:");
