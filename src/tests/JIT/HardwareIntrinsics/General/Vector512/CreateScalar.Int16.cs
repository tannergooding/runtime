...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateScalarInt16
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Int16> result = Vector512.CreateScalar(value);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.CreateScalar), new Type[] { typeof(Int16) })
        ...
        private void ValidateResult(Int16[] resultElements, Int16 expectedValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.CreateScalar(Int16): {method} failed:");
