...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateVectorInt64
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector256<Int64> lower = Vector256.Create(lowerValue);

            Int64 upperValue = TestLibrary.Generator.GetInt64();
            Vector256<Int64> upper = Vector256.Create(upperValue);

            Vector512<Int64> result = Vector512.Create(lower, upper);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.Create), new Type[] { typeof(Vector256<Int64>), typeof(Vector256<Int64>) })
                                .Invoke(null, new object[] { lower, upper });

            ValidateResult((Vector512<Int64>)(result), lowerValue, upperValue);
        }

        private void ValidateResult(Vector512<Int64> result, Int64 expectedLowerValue, Int64 expectedUpperValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Int64[] resultElements, Int64 expectedLowerValue, Int64 expectedUpperValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.Create(Int64): {method} failed:");
