...
namespace JIT.HardwareIntrinsics.General
{
    ...
    public sealed unsafe class VectorCreate__CreateScalarUnsafeSingle
    {
        ...
        public void RunBasicScenario()
        {
            ...
            Vector512<Single> result = Vector512.CreateScalarUnsafe(value);
        ...
        public void RunReflectionScenario()
        {
            ...
            object result = typeof(Vector512)
                                .GetMethod(nameof(Vector512.CreateScalarUnsafe), new Type[] { typeof(Single) })
                                .Invoke(null, new object[] { value });

            ValidateResult((Vector512<Single>)(result), value);
        }

        private void ValidateResult(Vector512<Single> result, Single expectedValue, [CallerMemberName] string method = "")
        {
        ...
        private void ValidateResult(Single[] resultElements, Single expectedValue, [CallerMemberName] string method = "")
        {
            ...
            if (!succeeded)
            {
                TestLibrary.TestFramework.LogInformation($"Vector512.CreateScalarUnsafe(Single): {method} failed:");
