...
#define XArchIntrinsicConstants_Gfni (1 << 12)
#define XArchIntrinsicConstants_Sha (1 << 13)
#define XArchIntrinsicConstants_Vaes (1 << 14)
#define XArchIntrinsicConstants_WaitPkg (1 << 15)
#define XArchIntrinsicConstants_X86Serialize (1 << 16)
