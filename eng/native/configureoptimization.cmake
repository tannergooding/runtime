if(CLR_CMAKE_HOST_WIN32)
    ...
    elseif (CLR_CMAKE_TARGET_ARCH_ARM64)
        add_compile_options($<$<COMPILE_LANGUAGE:C,CXX>:/arch:armv8.1>)
    endif()
elseif(CLR_CMAKE_HOST_UNIX)
    ...
    # Select the ISA baseline
    if (CLR_CMAKE_HOST_ARCH_I386 OR CLR_CMAKE_TARGET_ARCH_AMD64)
        add_compile_options($<$<COMPILE_LANGUAGE:C,CXX>:-mcpu=x86-64-v2>)
    elseif (CLR_CMAKE_TARGET_ARCH_ARM64)
        add_compile_options($<$<COMPILE_LANGUAGE:C,CXX>:-mcpu=armv8.1-a>)
    endif()
endif()
